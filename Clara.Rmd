...
* Lower EIBMR1(Energy intake) increases obese probability (since the coefficient -0.434 is negative).
* Lower ADTOTSE(Total mins spent sitting or lying down) increases obese probability (since the coefficient -4.590553e-05 is negative).
...
```
##Comment:
* 91.4 percent of people whose BMR are less than 6103 are normal (not obese).
...
| Obesity | BMR < 6103 | 6103 < BMR < 8297 | BMR > 8297 |
|---------|----------|---------------|----------|
| male    | 8.6%     | 6.7%          | 68.5%    |



| Obesity | BMR < 6103 | 6103 < BMR < 6390 | BMR > 6390 |
|---------|----------|---------------|----------|
| female  | 8.6%     | 45.8%         | 80.1%    |
